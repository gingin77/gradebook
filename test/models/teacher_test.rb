...
class TeacherTest < ActiveSupport::TestCase
  setup do
    ...
    @teacher = @teacher_user.identifiable
  ...
  test 'teaecher has a name (proper) and a username' do
    assert_not_nil @teacher_user.username
    assert_not_nil @teacher_user.identifiable.name
  end
